...
CREATE TABLE books_comments(id BIGINT AUTO_INCREMENT PRIMARY KEY, book_id BIGINT REFERENCES books(id) ON DELETE CASCADE, commenting_time DATETIME, author VARCHAR(255), comment VARCHAR(255));
