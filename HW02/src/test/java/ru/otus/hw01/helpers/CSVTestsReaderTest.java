...
public class CSVTestsReaderTest {
    ...
    private  ru.otus.hw01.models.Test[] prepareExpectedTestsArr(){
        long testId = 1;
        long questionId = 1;
        long answerId = 1;

        ru.otus.hw01.models.Test[] tests = {new ru.otus.hw01.models.Test(testId++, String.format(TEST_NAME_TEMPLATE, 1), 1, new ArrayList<>()),
                new ru.otus.hw01.models.Test(testId, String.format(TEST_NAME_TEMPLATE, 2), 2, new ArrayList<>())};
    ...
    private String prepareCSVData(ru.otus.hw01.models.Test[] expectedTestsArr){
    ...
    public void readTests() throws Exception {
        ru.otus.hw01.models.Test[] expectedTestsArr = prepareExpectedTestsArr();
        Map<Long, ru.otus.hw01.models.Test> expectedTests = new HashMap<>();
        ...
        Map<Long, ru.otus.hw01.models.Test> actualTests = new HashMap<>();
