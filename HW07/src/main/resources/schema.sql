...
CREATE TABLE books_comments(id BIGINT AUTO_INCREMENT PRIMARY KEY, book_id BIGINT, commenting_time DATETIME, author VARCHAR(255), comment VARCHAR(255), FOREIGN KEY(book_id) REFERENCES books(id) ON DELETE CASCADE);
